...
public class ManageCityActivity extends AppCompatActivity {
    ...
    private void makeDailog(final int mk) {
        ...
        dialog.setMessage("您确定要删除这个城市吗？删除该数据不可恢复哦！😱");
        ...
        dialog.setPositiveButton("删除", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                editor.commit();
                reloadCity();
                Toast.makeText(ManageCityActivity.this,"删除城市成功！走你┏ (゜ω゜)=☞", Toast.LENGTH_LONG).show();
        ...
        dialog.setNegativeButton("取消", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(ManageCityActivity.this,"啊哈！放心数据都还在👌", Toast.LENGTH_LONG).show();
